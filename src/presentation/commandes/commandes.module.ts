...
import { CreateCommandeUseCase } from '../../application/commandes/create-commande.use-case';
import { AddPaiementUseCase } from '../../application/commandes/add-paiement.use-case';
import { ChangeStatutUseCase } from '../../application/commandes/change-statut.use-case';
import { GetCommandesUseCase } from '../../application/commandes/get-commandes.use-case';
import { GetCommandeByIdUseCase } from '../../application/commandes/get-commande-by-id.use-case';

import { PrismaCommandeRepository } from '../../infrastructure/database/repositories/prisma-commande.repository';
import { PrismaPaiementRepository } from '../../infrastructure/database/repositories/prisma-paiement.repository';
...
@Module({
  ...
  providers: [
    ...
    { provide: COMMANDE_REPOSITORY, useClass: PrismaCommandeRepository },
    { provide: PAIEMENT_REPOSITORY, useClass: PrismaPaiementRepository },
