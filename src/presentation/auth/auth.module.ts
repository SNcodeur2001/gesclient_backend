...
import { TokenBlacklistServiceImpl } from '../../infrastructure/services/token-blacklist.service';
...
@Module({
  ...
  providers: [
    ...
    { provide: TOKEN_BLACKLIST_SERVICE, useClass: TokenBlacklistServiceImpl },
  ],
